# Buildoser Site Instructions & Rules

## Rule for Adding New Calculators / Tools
Whenever a new calculator/tool is added to Buildoser, ALWAYS automatically update all of the following without waiting to be asked:
...
3. **Routing & SEO Metadata (`src/App.tsx`)**:
   - Add the route to `ROUTE_METADATA` with title, description, and canonical URL (`https://buildoser.vercel.app/tools/...`).
