      ...
      <div className="mb-14">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base text-[#54524D] leading-relaxed">
            Buildoser is building the single most precise suite of architectural and DIY measurement instruments. Starting with our calibrated Paint Engine, each calculator treats physical materials with engineering precision.
          </p>
        </div>
      </div>
