...
const ROUTE_METADATA: Record<string, PageMetadata> = {
  ...
  '/tools/flooring-calculator': {
    title: 'Flooring Calculator — How Much Flooring Do I Need? | Buildoser',
    description: 'Use the Buildoser flooring calculator to find how much flooring you need for a room or floor area. Calculate floor area and add extra material for cuts and waste.',
  ...
  '/tools/paint-calculator': {
    title: 'Paint Calculator — How Much Paint Do I Need? | Buildoser',
  ...
  '/tools/gravel-calculator': {
    title: 'Gravel Calculator — How Much Gravel Do I Need? | Buildoser',
    description: 'Use the Buildoser gravel calculator to find how much gravel you need. Calculate gravel volume, cubic yards, cubic metres, and estimated weight for driveways, paths, gardens, and landscaping.',
  ...
  '/tools/sand-calculator': {
    title: 'Sand Calculator — How Much Sand Do I Need? | Buildoser',
    description: 'Use the Buildoser sand calculator to find how much sand you need. Calculate sand volume, cubic yards, cubic metres, and estimated weight for landscaping and other projects.',
  ...
  '/tools/mulch-calculator': {
    title: 'Mulch Calculator — How Much Mulch Do I Need? | Buildoser',
    description: 'Use the Buildoser mulch calculator to find how much mulch you need. Calculate mulch volume in cubic metres or cubic yards and estimated weight for garden beds, landscaping, and trees.',
  ...
  '/tools/topsoil-calculator': {
    title: 'Topsoil Calculator — How Much Topsoil Do I Need? | Buildoser',
    description: 'Use the Buildoser topsoil calculator to find how much topsoil you need. Calculate topsoil volume in cubic metres or cubic yards and estimated weight for gardens, lawns, and raised beds.',
  ...
  '/tools/concrete-calculator': {
    title: 'Concrete Calculator — How Much Concrete Do I Need? | Buildoser',
    description: 'Use the Buildoser concrete calculator to find how much concrete you need. Calculate concrete volume in cubic metres or cubic yards for slabs, footings, driveways, and patios.',
  ...
  '/tools/tile-calculator': {
    title: 'Tile Calculator — How Many Tiles Do I Need? | Buildoser',
    description: 'Use the Buildoser tile calculator to find how many tiles you need. Calculate tile quantities for floors and walls based on surface area and tile dimensions with extra allowance for cuts and waste.',
  ...
  '/tools/drywall-calculator': {
    title: 'Drywall Calculator — How Many Sheets Do I Need? | Buildoser',
    description: 'Use the Buildoser drywall calculator to find how many drywall sheets you need. Calculate sheet counts for walls and ceilings based on surface area and sheet dimensions with extra allowance for waste.',
  ...
  '/tools/paver-calculator': {
    title: 'Paver Calculator — How Many Pavers Do I Need? | Buildoser',
    description: 'Use the Buildoser paver calculator to find how many pavers you need. Calculate paver quantities for patios, walkways, and driveways based on surface area and paver dimensions with extra allowance for cuts and waste.',
  ...
  '/tools/sod-calculator': {
    title: 'Sod Calculator — How Much Sod Do I Need? | Buildoser',
    description: 'Use the Buildoser sod calculator to find how much sod you need. Calculate sod amount and lawn surface area for turf grass installation with extra allowance for curves and cutting waste.',
  ...
  '/tools/roofing-calculator': {
    title: 'Roofing Calculator — How Much Roofing Do I Need? | Buildoser',
    description: 'Use the Buildoser roofing calculator to find how much roofing material you need. Calculate roof surface area and recommended roofing material with extra allowance for ridges, valleys, and cutting waste.',
  ...
  '/tools/fence-calculator': {
    title: 'Fence Calculator — How Much Fencing Do I Need? | Buildoser',
    description: 'Use the Buildoser fence calculator to find how much fencing material you need. Calculate fence surface area and recommended fencing material with extra allowance for trimming and cut waste.',
  ...
  '/guides': {
    title: 'Buildoser Guides — Simple Home & DIY Material Guides',
  ...
  '/guides/how-much-extra-flooring-should-you-buy': {
    title: 'How Much Extra Flooring Should You Buy? | Buildoser Guide',
  ...
  '/guides/what-flooring-waste-percentage-should-you-use': {
    title: 'What Flooring Waste Percentage Should You Use? | Buildoser Guide',
  ...
  '/guides/how-to-measure-an-l-shaped-room-for-flooring': {
    title: 'How to Measure an L-Shaped Room for Flooring | Buildoser Guide',
  ...
  '/guides/how-much-flooring-do-i-need-for-a-10x10-room': {
    title: 'How Much Flooring Do I Need for a 10×10 Room? | Buildoser Guide',
  ...
  '/guides/how-much-gravel-do-i-need-for-a-driveway': {
    title: 'How Much Gravel Do I Need for a Driveway? | Buildoser Guide',
  ...
  '/guides/how-deep-should-driveway-gravel-be': {
    title: 'How Deep Should Driveway Gravel Be? | Buildoser Guide',
  ...
  '/guides/how-many-tons-of-gravel-do-i-need': {
    title: 'How Many Tons of Gravel Do I Need? | Buildoser Guide',
  ...
  '/guides/how-to-calculate-gravel-for-an-irregular-area': {
    title: 'How to Calculate Gravel for an Irregular Area | Buildoser Guide',
  ...
  '/guides/how-much-paint-do-i-need-for-2-coats': {
    title: 'How Much Paint Do I Need for 2 Coats? | Buildoser Guide',
  ...
  '/guides/do-you-calculate-paint-from-wall-area-or-floor-area': {
    title: 'Do You Calculate Paint From Wall Area or Floor Area? | Buildoser Guide',
  ...
  '/guides/how-much-paint-do-i-need-for-one-room': {
    title: 'How Much Paint Do I Need for One Room? | Buildoser Guide',
  ...
  '/guides/how-much-paint-do-i-need-for-a-ceiling': {
    title: 'How Much Paint Do I Need for a Ceiling? | Buildoser Guide',
  ...
  '/about': {
    title: 'About Buildoser',
    description: 'Buildoser creates simple calculators that help you estimate the materials needed for everyday home and DIY projects.',
    canonical: `${PRODUCTION_DOMAIN}/about`,
  },
  '/contact': {
    title: 'Contact Buildoser',
    description: 'Have a question, found a problem, or have an idea for a calculator? Contact Buildoser.',
    canonical: `${PRODUCTION_DOMAIN}/contact`,
  },
  '/privacy-policy': {
    title: 'Privacy Policy | Buildoser',
    description: 'Learn how Buildoser protects your privacy, uses anonymous calculator inputs, and handles cookies and analytics.',
    canonical: `${PRODUCTION_DOMAIN}/privacy-policy`,
  },
  '/terms': {
    title: 'Terms of Use | Buildoser',
    description: 'Read the Terms of Use for Buildoser. Understand material calculator estimates, user responsibilities, and site terms.',
