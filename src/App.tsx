...
const ROUTE_METADATA: Record<string, PageMetadata> = {
  ...
  '/tools/flooring-calculator': {
    title: 'Flooring Calculator — How Much Flooring Do I Need? | ProjectTally',
    description: 'Use the ProjectTally flooring calculator to find how much flooring you need for a room or floor area. Calculate floor area and add extra material for cuts and waste.',
  ...
  '/tools/paint-calculator': {
    title: 'Paint Calculator — How Much Paint Do I Need? | ProjectTally',
  ...
  '/tools/gravel-calculator': {
    title: 'Gravel Calculator — How Much Gravel Do I Need? | ProjectTally',
    description: 'Use the ProjectTally gravel calculator to find how much gravel you need. Calculate gravel volume, cubic yards, cubic metres, and estimated weight for driveways, paths, gardens, and landscaping.',
  ...
  '/tools/sand-calculator': {
    title: 'Sand Calculator — How Much Sand Do I Need? | ProjectTally',
    description: 'Use the ProjectTally sand calculator to find how much sand you need. Calculate sand volume, cubic yards, cubic metres, and estimated weight for landscaping and other projects.',
  ...
  '/tools/mulch-calculator': {
    title: 'Mulch Calculator — How Much Mulch Do I Need? | ProjectTally',
    description: 'Use the ProjectTally mulch calculator to find how much mulch you need. Calculate mulch volume in cubic metres or cubic yards and estimated weight for garden beds, landscaping, and trees.',
  ...
  '/tools/topsoil-calculator': {
    title: 'Topsoil Calculator — How Much Topsoil Do I Need? | ProjectTally',
    description: 'Use the ProjectTally topsoil calculator to find how much topsoil you need. Calculate topsoil volume in cubic metres or cubic yards and estimated weight for gardens, lawns, and raised beds.',
  ...
  '/tools/concrete-calculator': {
    title: 'Concrete Calculator — How Much Concrete Do I Need? | ProjectTally',
    description: 'Use the ProjectTally concrete calculator to find how much concrete you need. Calculate concrete volume in cubic metres or cubic yards for slabs, footings, driveways, and patios.',
  ...
  '/tools/tile-calculator': {
    title: 'Tile Calculator — How Many Tiles Do I Need? | ProjectTally',
    description: 'Use the ProjectTally tile calculator to find how many tiles you need. Calculate tile quantities for floors and walls based on surface area and tile dimensions with extra allowance for cuts and waste.',
  ...
  '/tools/drywall-calculator': {
    title: 'Drywall Calculator — How Many Sheets Do I Need? | ProjectTally',
    description: 'Use the ProjectTally drywall calculator to find how many drywall sheets you need. Calculate sheet counts for walls and ceilings based on surface area and sheet dimensions with extra allowance for waste.',
  ...
  '/tools/paver-calculator': {
    title: 'Paver Calculator — How Many Pavers Do I Need? | ProjectTally',
    description: 'Use the ProjectTally paver calculator to find how many pavers you need. Calculate paver quantities for patios, walkways, and driveways based on surface area and paver dimensions with extra allowance for cuts and waste.',
  ...
  '/tools/sod-calculator': {
    title: 'Sod Calculator — How Much Sod Do I Need? | ProjectTally',
    description: 'Use the ProjectTally sod calculator to find how much sod you need. Calculate sod amount and lawn surface area for turf grass installation with extra allowance for curves and cutting waste.',
  ...
  '/tools/roofing-calculator': {
    title: 'Roofing Calculator — How Much Roofing Do I Need? | ProjectTally',
    description: 'Use the ProjectTally roofing calculator to find how much roofing material you need. Calculate roof surface area and recommended roofing material with extra allowance for ridges, valleys, and cutting waste.',
  ...
  '/tools/fence-calculator': {
    title: 'Fence Calculator — How Much Fencing Do I Need? | ProjectTally',
    description: 'Use the ProjectTally fence calculator to find how much fencing material you need. Calculate fence surface area and recommended fencing material with extra allowance for trimming and cut waste.',
  ...
  '/guides': {
    title: 'ProjectTally Guides — Simple Home & DIY Material Guides',
  ...
  '/guides/how-much-gravel-do-i-need': {
    title: 'How Much Gravel Do I Need? | ProjectTally Guide',
  ...
  '/guides/how-much-sand-do-i-need': {
    title: 'How Much Sand Do I Need? | ProjectTally Guide',
  ...
  '/guides/how-much-paint-do-i-need': {
    title: 'How Much Paint Do I Need for a Room? | ProjectTally Guide',
  ...
  '/guides/how-much-flooring-do-i-need': {
    title: 'How Much Flooring Do I Need? | ProjectTally Guide',
  ...
  '/guides/how-much-concrete-do-i-need': {
    title: 'How Much Concrete Do I Need? | ProjectTally Guide',
  ...
  '/about': {
    title: 'About ProjectTally',
    description: 'ProjectTally creates simple calculators that help you estimate the materials needed for everyday home and DIY projects.',
    canonical: `${PRODUCTION_DOMAIN}/about`,
  },
  '/contact': {
    title: 'Contact ProjectTally',
    description: 'Have a question, found a problem, or have an idea for a calculator? Contact ProjectTally.',
